        ...
        <div className="flex-1 overflow-y-auto px-4 py-5">
          <div className="rounded-[24px] border border-slate-200 bg-[radial-gradient(circle_at_top_left,#f8fafc,white_55%,#eef2ff)] p-4">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-600">
              Manage escrow, trades, milestone releases, payments, and ramp
            ...
            <div className="space-y-4">
              {escrows.slice(0, 2).map((item) => (
                <ListCard
                  ...
                  right={
                    <Button className="rounded-2xl border border-slate-200 bg-white text-slate-900 shadow-none hover:bg-slate-100">
                      Open
                    </Button>
                  }
                >
  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          <div className="absolute inset-x-0 top-0 h-24 bg-[radial-gradient(circle_at_top_left,#eef2ff_0%,#ffffff_58%,#ffffff_100%)] pointer-events-none" />
